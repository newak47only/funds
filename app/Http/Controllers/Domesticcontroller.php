...
class Domesticcontroller extends Controller
{
    //
        ...
        return view('domestic.list_city')->with(compact('information','emps','depts'));
    }
    ...
    public function report_list(){
        ...
        return view('domestic.report_list')->with(compact('information','emps'));
    ...
    public function outlist_city(){
        ...
        return view('domestic.outlist_city')->with(compact('information','emps'));
    ...
    public function ownlist_city(){
        ...
        return view('domestic.ownlist_city')->with(compact('information','emps'));
