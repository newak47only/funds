...
class NegotiationController extends Controller
{
    ...
    public function store(Request $request)
    {
         ...
         $data=$request->all();
             ...
             $test=DB::update('update information set reg_currency = ? where id = ?',[$data['reg_currency'],$info_id]);
             $test=DB::update('update information set scope = ? where id = ?',[$data['scope'],$info_id]);
             $test=DB::update('update information set investment = ? where id = ?',[$data['investment'],$info_id]);
             //dd($test);
