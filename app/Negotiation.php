...
class Negotiation extends Model
{
    ...
    protected $fillable=['id','info_id','emp_id','currency','investment','status','neg_at','remark','contract_file','report','eaction','daction','director_id','actiontype','result','check_day','updated_at'];
