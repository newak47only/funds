	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="<?php echo e(route('report.store')); ?>" method="post" class="form form-horizontal" id="form-admin-add">
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>项目名称：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo e($informations->name); ?>" placeholder="<?php echo e($informations->name); ?>" id="report_name" name="name " required>
						</div>
					</div>
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>投资金额：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo e($informations->investment); ?> " placeholder="<?php echo e($informations->investment); ?>" id="report_investment" name="investment"  >
					...
					<input type="hidden"  value="<?php echo e($actiontype); ?>"   name="actiontype" >
					<input type="hidden"  value="<?php echo e($users->currency); ?>"   name="currency" >
					<input type="hidden"  value="<?php echo e($informations->currency); ?>"  name="currency" >
					<input type="hidden"  value="<?php echo e($informations->id); ?>"  name="info_id" >
					<input type="hidden"  value="<?php echo e($eaction); ?>"  name="eaction" >
					<div class="row clearfix">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/report/add.blade.php ENDPATH**/ ?>