									...
									<tbody>
										...
										<tr class="text-c">
											...
											<td class="td-manage">
												...
												<?php if($v->process == 1): ?>
												<button type="submit"  href="javascript:;" onclick="circule_cheack('流转项目分发','/circule/check/<?php echo e($v->id); ?>')"  class="f-l ml-10 btn btn-danger radius size-S">&nbsp;&nbsp;<i class="Hui-iconfont">&#xe6bd;</i>&nbsp;&nbsp;项目分发&nbsp;&nbsp;&nbsp;</button>
												<?php elseif($v->process != 1): ?>	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/circule/outlist_all.blade.php ENDPATH**/ ?>