								...
								<table class="table table-border table-bordered table-bg table-hover table-sort">
									...
									<tbody>
										...
										<?php endif; ?></td>
											...
											<td><u style="cursor:pointer" class="text-primary" onClick="information_show('查看落户地联系人信息','<?php echo e(route('emp.show',$v['emp_id'])); ?>','<?php echo e($v['emp_id']); ?>')" title="查看落户地联系人信息"><?php echo e($v['circule_n_name']); ?></u></td>
											<td><?php echo e($v['circule_f_dept']); ?></td>
											<td><u style="cursor:pointer" class="text-primary" onClick="information_show('查看首谈联系人信息','<?php echo e(route('emp.show',$v['circule_id'])); ?>','<?php echo e($v['circule_id']); ?>')" title="查看首谈联系人信息"><?php echo e($v['circule_f_name']); ?></u></td>
											...
											<td class="td-manage">
												...
												<button type="submit"  href="javascript:;" onclick="information_show('查看数据','/statistics/<?php echo e($v['id']); ?>')"  class="f-l ml-10 btn btn-primary radius size-S"><i class="Hui-iconfont" style="font-size: 16px">&#xe61c;</i>&nbsp;&nbsp;查看数据&nbsp;&nbsp;</button>										
											</td>
										</tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/negotiation/inlist_all.blade.php ENDPATH**/ ?>