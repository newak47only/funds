						...
						<div class="col-24-xs-8" style="padding-left: 12px; padding-right: 12px; margin-bottom: 24px;">
							<div class="panel">
								...
								<div class="panel-body" style="padding:10px 24px;">
									...
									<?php if($v->id <= 24): ?>
										<span style="font-weight: bold;"><?php echo e($v->dept_name); ?>:</span>
												在库项目<span class="c-primary" style="font-size: 18px;line-height: 18px; font-weight: bold; color: red;"><em><?php echo e($v->num1); ?></em></span>&nbsp;个，流转项目<span class="c-primary" style="font-size: 18px;line-height: 18px; font-weight: bold;color: red;"><em><?php echo e($v->num1); ?></em></span>&nbsp;个;<br />
										<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/welcome.blade.php ENDPATH**/ ?>