	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				...
				<input type="hidden"  value="<?php echo e($informations->currency); ?>" placeholder="" id="negotiation_currency" name="currency" >
				...
				<input type="hidden"  value="<?php echo e($informations->investment); ?>"  name="investment" >
