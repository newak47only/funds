									...
									<tbody>
										...
										<?php endif; ?></td>
											...
											<td class="td-manage">
												...
												<button type="submit"  href="javascript:;" onclick="negotiation_create('查看数据','/statistics/<?php echo e($v['id']); ?>')"  class="f-l ml-10 btn btn-primary radius size-S"><i class="Hui-iconfont" style="font-size: 16px">&#xe61c;</i>&nbsp;&nbsp;查看数据&nbsp;&nbsp;</button>	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/negotiation/ownlist_all.blade.php ENDPATH**/ ?>