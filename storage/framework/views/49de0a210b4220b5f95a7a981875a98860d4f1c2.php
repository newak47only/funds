								...
								<table class="table table-border table-bordered table-bg table-hover table-sort">
									...
									<tbody>
										...
										<tr class="text-c">
											...
											<td><?php $__currentLoopData = $emps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											...
											<td class="td-manage">
												...
												<?php if($v['is_show']==0): ?>
												<button type="submit"  href="javascript:;" onclick="report_add('项目上报','/report/add/<?php echo e($v['id']); ?>')"  class=" f-l ml-10  mt-5 mb-5 btn btn-primary radius size-S ">&nbsp;&nbsp;<i class="Hui-iconfont">&#xe6aa;</i>&nbsp;&nbsp;信息上报&nbsp;&nbsp;&nbsp;</button>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/information/list_all.blade.php ENDPATH**/ ?>