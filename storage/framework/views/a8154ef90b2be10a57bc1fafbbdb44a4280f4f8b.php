	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				...
				<form action="/circule/resetupdate/<?php echo e($information->id); ?>" method="POST"  class="form form-horizontal" id="form-admin-add" >
						...
						<div class="form-controls col-xs-8 col-sm-9 skin-minimal">
							...
							<?php elseif($val->id != 6 && $val->id != 13 && $val->id != 1 && $val->id != 2 && $val->id != $information->circule_to && $val->id != $information->info_emp->dept_id  ): ?>
							<div class="radio-box">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/circule/cirreset.blade.php ENDPATH**/ ?>