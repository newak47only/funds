						...
						<span class="f-l">
							...
							<div class="mt-20 clearfix">
								<table class="table table-border table-bordered table-bg table-hover table-sort">
									<thead>
										<tr class="text-c">
											<th width="25"><input type="checkbox" name="box" value=""></th>
											<th width="40">ID</th>
									...
									<tbody>
										...
										<tr class="text-c">
											...
											<td class="text-l"><u style="cursor:pointer" class="text-primary" onClick="information_edit('编辑项目','<?php echo e(route('information.edit',$v->id)); ?>','<?php echo e($v->id); ?>')" title="编辑项目"><?php echo e($v->name); ?></u></td>
											...
											<td><u style="cursor:pointer" class="text-primary" onClick="recode_show('查看工作记录','<?php echo e(route('recode.show',$v->id)); ?>','<?php echo e($v->id); ?>')" title="查看工作记录"><?php echo e($v->recodenum); ?>条</u></td>
											<?php if($v->is_show==0): ?>
											<td>未上报</td>
											...
											<td class="td-manage">
												...
												<button type="submit"  href="javascript:;" onclick="info_recode_add('进度记录','/recode/add/<?php echo e($v->id); ?>')"  class=" f-l ml-10  mt-5 mb-5 btn btn-primary radius size-S ">&nbsp;<i class="Hui-iconfont">&#xe6df;</i>&nbsp;进度记录&nbsp;&nbsp;</button>
												<button type="submit"  href="javascript:;" onclick="info_nego_add('项目落地','/negotiation/add/<?php echo e($v->id); ?>')"  class=" f-l ml-10 btn btn-primary radius size-S mt-5 mb-5">&nbsp;<i class="Hui-iconfont">&#xe640;</i>&nbsp;项目落地&nbsp;&nbsp;</button>
												<?php if($v->recodenum >= 3): ?>
												<button type="submit"  href="javascript:;" onclick="info_cir_add('项目流转','/circule/add/<?php echo e($v->id); ?>')"  class="f-l ml-10 btn btn-primary radius size-S mt-5 mb-5">&nbsp;<i class="Hui-iconfont">&#xe6bd;</i>&nbsp;项目流转&nbsp;&nbsp;</button>
												<?php elseif($v->recodenum < 3): ?>
  			...
  			layer.confirm('确认要终止项目吗？',{title:'终止项目'},function(index){
                $.ajax({
					...
					error:function(XmlHttpRequest,textStatus,errorThrown){
						layer.msg('项目终止成功！',{ icon: 1,time:1000},function(){
						var index = parent.layer.getFrameIndex(window.name);
						parent.location.replace(parent.location.href);
						parent.layer.close(index);
								});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/information/ownlist.blade.php ENDPATH**/ ?>