	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="<?php echo e(route('recode.store')); ?>" method="post" class="form form-horizontal" id="form-admin-add">
					<div class="row clearfix">
						<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>洽谈对象：</label>
						<div class="form-controls col-xs-8 col-sm-9">
							<input type="text" class="input-text" value="<?php echo e($information->cont_name); ?>" placeholder="" id="elephant" name="elephant" required>
						</div>
					</div>
					...
					<input type="hidden" name="emp_id" value="<?php echo e($admin_id); ?>">
		...
		$(function(){
			...
			$("#form-admin-add").validate({
				...
				submitHandler:function(form){
					$(form).ajaxSubmit({
						type:'post',
						url:'<?php echo e(route('recode.store')); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/recode/add.blade.php ENDPATH**/ ?>