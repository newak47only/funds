											...
											<td>
												<?php $__currentLoopData = $emps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
													<?php if($m->id == $v['issuer_id']): ?>
														<u style="cursor:pointer" class="text-primary" onClick="information_show('查看项目发布人信息','<?php echo e(route('emp.show',$v['issuer_id'])); ?>','<?php echo e($v['issuer_id']); ?>')" title="查看项目发布人信息"><?php echo e($m->username); ?></u>
													<?php endif; ?>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</td>

											<td><u style="cursor:pointer" class="text-primary" onClick="information_add('查看工作记录','/recode/show/<?php echo e($v['id']); ?>','<?php echo e($v['id']); ?>')" title="查看工作记录"><?php echo e($v['recodenum']); ?>条</u></td>
											<td class="td-manage">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/foreign/ownlist_city.blade.php ENDPATH**/ ?>