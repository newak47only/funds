	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				...
				<form action="/circule/examupdate/<?php echo e($information->id); ?>" method="POST"  class="form form-horizontal" id="form-admin-add" >
        				...
        				<tr>
          					...
          					<td>
          						<?php $__currentLoopData = $depts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<?php if($n->id == $information->circule_to): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/circule/examine.blade.php ENDPATH**/ ?>