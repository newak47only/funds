	...
	<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				...
				<form action="<?php echo e(route('circule.update',$information->id)); ?>" method="post"  class="form form-horizontal" id="form-admin-add" >
				...
				<div class="row clearfix">
					...
					<div class="form-controls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="<?php echo e($information->name); ?>" placeholder="<?php echo e($information->name); ?>" id="name" name="  " datatype="*4-16" >
					</div>
				</div>
				<div class="row clearfix">
				...
				<div class="row clearfix">
					...
					<div class="form-controls col-xs-8 col-sm-9">
						...
						<?php if($information->currency == '1'): ?>该项目注册资金单位为：万人民币<?php elseif($information->currency == '2'): ?>该项目注册资金单位为：万美元<?php elseif($information->currency == '3'): ?>该项目注册资金单位为：万欧元<?php endif; ?>
					</div>					
				</div>
				<div class="row clearfix">
				...
				<div class="row clearfix">
					...
					<div class="form-controls col-xs-8 col-sm-9">
						...
						<input type="hidden" name="name" value="<?php echo e($information->name); ?>">
  ...
  <script type="text/javascript" src="/lib/bootstrap-datetimepicker.zh-CN.js"></script>
    ...
    uploader = WebUploader.create({
    	...
    	formData:{
    		...
    		emp_id:"<?php echo e($information->emp_id); ?>",
    		actiontype:"<?php echo e($actiontype); ?>",
    		info_id:"<?php echo e($information->id); ?>",
    	},
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/circule/redit.blade.php ENDPATH**/ ?>