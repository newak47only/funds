									...
									<tbody>
										<?php $__currentLoopData = $information1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											...
											<td class="td-manage">
												...
												<?php if($v->process == '22'): ?>
												<button type="submit"  href="javascript:;" onclick="information_show('项目分派审核','/circule/tccheck/<?php echo e($v->id); ?>')"  class=" f-l ml-10 btn btn-danger radius size-S">&nbsp;&nbsp;<i class="Hui-iconfont" style="font-size: 16px">&#xe6bd;</i>&nbsp;&nbsp;分派审核&nbsp;&nbsp;&nbsp;</button>
												<?php else: ?>
												<button type="submit"  href="javascript:;" onclick=""  class="f-l ml-10 btn btn-disabled radius size-S">&nbsp;&nbsp;<i class="Hui-iconfont" style="font-size: 16px">&#xe6bd;</i>&nbsp;&nbsp;分派审核&nbsp;&nbsp;&nbsp;</button>
												<?php endif; ?>
											</td>
										</tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Code/funds/resources/views/circule/tclist_all.blade.php ENDPATH**/ ?>