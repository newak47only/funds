  ...
  <aside class="Hui-admin-aside-wrapper">
    ...
    <div class="Hui-admin-menu-dropdown bk_2">
        ...
        <dd class="Hui-menu-item">
          <ul>
            <li><a data-href="foreign/list_city" data-title="流转项目列表" href="javascript:void(0)">流转项目列表&nbsp;@if($count != 0)<span  class=" badge badge-danger radius " style=" display: block; overflow: hidden; float:right; margin-right:92px; margin-top:8px;  padding-right:5px;padding-left:5px;  border-radius:12px ;  color:#fff;">{{$count}}</a></span>@endif</li>
            <li><a data-href="foreign/report_list" data-title="上报项目列表" href="javascript:void(0)">上报项目列表&nbsp;</a></li>
          </ul>
        </dd>
      </dl>
      <dl id="menu-landing" class="Hui-menu">
        <dt class="Hui-menu-title"><i class="Hui-iconfont">&#xe613;</i>&nbsp;全市落地项目库<i class="Hui-iconfont Hui-admin-menu-dropdown-arrow">&#xe6d5;</i></dt>
         <dd class="Hui-menu-item">
          <ul>
            <li><a data-href="foreign/outlist_city" data-title="流转项目落地列表" href="javascript:void(0)">流转项目落地列表</a></li>
            <li><a data-href="foreign/ownlist_city" data-title="首谈项目落地列表" href="javascript:void(0)">首谈项目落地列表</a></li>
          </ul>
        </dd>
      </dl>
