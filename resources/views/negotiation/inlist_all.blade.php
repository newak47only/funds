								...
								<table class="table table-border table-bordered table-bg table-hover table-sort">
									...
									<tbody>
										...
										@endif</td>
											...
											<td class="td-manage">
												<button type="submit"  href="javascript:;" onclick="information_show('查看记录','/recode/{{$v['id']}}')"  class=" f-l ml-10 btn btn-primary radius size-S">&nbsp;&nbsp;<i class="Hui-iconfont">&#xe6df;</i>&nbsp;&nbsp;查看记录&nbsp;&nbsp;&nbsp;</button>
												<button type="submit"  href="javascript:;" onclick="information_show('查看数据','/statistics/{{$v['id']}}')"  class="f-l ml-10 btn btn-primary radius size-S"><i class="Hui-iconfont" style="font-size: 16px">&#xe61c;</i>&nbsp;&nbsp;查看数据&nbsp;&nbsp;</button>										
											</td>
										</tr>
										@endforeach
									</tbody>
