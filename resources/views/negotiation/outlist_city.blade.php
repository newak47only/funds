								...
								<table class="table table-border table-bordered table-bg table-hover table-sort">
									...
									<tbody>
										...
										@endif</td>
											...
											<td>
												<u style="cursor:pointer" class="text-primary" onClick="information_show('查看首谈联系人信息','{{route('emp.show',$v['emp_id'])}}','{{$v['emp_id']}}')" title="查看首谈联系人信息">{{$v['circule_f_name']}}</u>
											</td>
											<td>{{$v['circule_n_dept']}}</td>
											<td>
												<u style="cursor:pointer" class="text-primary" onClick="information_show('查看首谈联系人信息','{{route('emp.show',$v['circule_id'])}}','{{$v['circule_id']}}')" title="查看首谈联系人信息">{{$v['circule_n_name']}}</u>
											</td>
											
											<td>
												<u style="cursor:pointer" class="text-primary" onClick="information_show('查看项目跟踪人信息','{{route('emp.show',$v['check_id'])}}','{{$v['check_id']}}')" title="查看项目跟踪人信息">
													{{$v['track']}}
												</u>
											</td>
