  ...
  <aside class="Hui-admin-aside-wrapper">
    ...
    <div class="Hui-admin-menu-dropdown bk_2">
      ...
      <dl id="menu-negotiation" class="Hui-menu">
        ...
        <dd class="Hui-menu-item">
          <ul>
            <li><a data-href="circule/tclist_all" data-title="本部门发布转项目列表" href="javascript:void(0)">本部门发布转项目列表@if($owncount != 0 )<span  class=" badge badge-danger radius " style=" display: block; overflow: hidden; float:right; margin-right:52px; margin-top:8px;  padding-right:5px;padding-left:5px;  border-radius:12px ;  color:#fff;">{{$owncount}}</a></span>@endif</li>
      ...
      <div class="navbar">
        <div class="container-fluid clearfix">
          <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar">
            <ul class="clearfix">
              <li>{{ $dept_name}}@if($status == 1 || $status == 3  )管理员@else 招商人员@endif</li>
