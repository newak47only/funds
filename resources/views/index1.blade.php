    ...
    <div class="Hui-admin-menu-dropdown bk_2">
      @if($status == 0)
        ...
        <dd class="Hui-menu-item">
          <ul>
            <li>@if($checkcount != 0)<a data-href="circule/list_city" data-title="流转项目列表" href="javascript:void(0)">流转项目列表<span  class=" badge badge-danger radius " style=" display: block; overflow: hidden; float:right; margin-right:94px; margin-top:8px;  padding-right:5px;padding-left:5px;  border-radius:12px ;  color:#fff;">{{$checkcount}}</a></span>
              @else
      ...
      @elseif($status == 2)
        ...
        <dd class="Hui-menu-item">
          <ul>
            <li><a data-href="information/ownlist" data-title="本人首谈项目列表" href="javascript:void(0)">本人首谈项目列表&nbsp;@if($tccount != 0 )<span  class=" badge badge-danger radius " style=" display: block; overflow: hidden; float:right; margin-right:66px; margin-top:8px;  padding-right:5px;padding-left:5px;  border-radius:12px ;  color:#fff;">{{$tccount}}</a></span>@endif</li>
      ...
      <dl id="menu-negotiation" class="Hui-menu">
        ...
        <dd class="Hui-menu-item">
          <ul>
            <li><a data-href="circule/tclist_all" data-title="本部门发布转项目列表" href="javascript:void(0)">本部门发布转项目列表@if($owncount != 0 )<span  class=" badge badge-danger radius " style=" display: block; overflow: hidden; float:right; margin-right:40px; margin-top:8px;  padding-right:5px;padding-left:5px;  border-radius:12px ;  color:#fff;">{{$owncount}}</a></span>@endif</li>
      ...
      <div class="navbar">
        <div class="container-fluid clearfix">
          <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar">
            <ul class="clearfix">
              <li>{{ $dept_name}}@if($status == 1 || $status == 3 || $status == 0   )管理员@else 招商人员@endif</li>
