									...
									<tbody>
										...
										<tr class="text-c">
											...
											<td class="td-manage">
												...
												@if($v->process == 21)
												<button type="submit"  href="javascript:;" onclick="recode_add('流转申请','/circule/tcadd/{{$v->id}}')"  class="btn btn-danger radius size-S">&nbsp;&nbsp;<i class="Hui-iconfont" style="font-size: 16px">&#xe666;</i>&nbsp;&nbsp;项目分派&nbsp;&nbsp;&nbsp;</button>
												@elseif($v->process == 22)
