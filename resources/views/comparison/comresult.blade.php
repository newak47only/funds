				...
				<table class="table table-border table-bordered table-hover">
      				<tbody>
      					...
      					<tr>
      						...
      						<td class="text-c"><u style="cursor:pointer" class="text-primary" onClick="information_show('查看相似项目','/comparison/hundredper/{{$info_id}}')" title="查看相似项目">{{$hundredper}}</u></td>
      					</tr>
      					<tr>
      						<td class="text-c">80%</td>
      						<td class="text-c">{{$eightpre}}</td>
      					</tr>
      					<tr>
